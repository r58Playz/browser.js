...
> **Read this as a lab notebook, not a specification.**
>
> There are 219 numbered rules in one flat list, appended to in the order they
> were learned. Some retract or correct earlier ones -- 219 retracts 218, 214
> corrects 212, 217 corrects 209 and 214 -- and the correction is at the BOTTOM,
> hundreds of rules after the thing it corrects. A rule's number is not evidence
> that it still holds, and reading rule N without reading to the end can give you
> a confident wrong answer.
>
> Rules 1-60 are the invariants proper: the tracer, the differ, determinism,
> process. Those are stable and are what "read RULES.md before changing
> anything" means. Everything past 60 is findings -- measurements about
> Cloudflare, rateyourmusic and the challenge, several of which are since
> retracted.
>
> Splitting the two is a job that has not been done. Until it is, search for the
> rule number in the rest of the file before relying on it: a correction cites
> what it corrects.
